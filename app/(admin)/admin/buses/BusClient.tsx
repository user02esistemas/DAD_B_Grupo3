...
import { Plus, Edit2, Trash2, Hash, Box, Settings } from "lucide-react";
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Administra la flota de vehículos, sus capacidades y configuración de asientos.
          </p>
        </div>
        <button
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                <th className="px-6 py-4 text-sm font-semibold text-gray-900">Placa</th>
                <th className="px-6 py-4 text-sm font-semibold text-gray-900">Marca</th>
                <th className="px-6 py-4 text-sm font-semibold text-gray-900 text-center">Capacidad</th>
                <th className="px-6 py-4 text-sm font-semibold text-gray-900 text-center">Pisos</th>
