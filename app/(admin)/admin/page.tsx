    ...
    <div>
      ...
      {(session?.user?.role === "admin" || session?.user?.role === "gerente") ? (
        ...
        <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl overflow-hidden relative">
          <div className="absolute top-0 right-0 w-64 h-64 bg-orange-50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
          <div className="relative z-10">
            <h3 className="text-2xl font-black text-slate-800 mb-2">¡Listo para tu turno!</h3>
            <p className="text-slate-500 font-medium max-w-lg mb-8">
              Bienvenido al sistema operativo de ventas. Desde aquí podrás gestionar rápidamente la venta de pasajes y el registro de encomiendas.
            </p>
            <div className="flex gap-4">
              <a href="/admin/pasajes" className="px-6 py-3 bg-[#f07639] hover:bg-[#d45a1f] text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-[#f07639]/30 flex items-center gap-2">
                <Ticket className="w-5 h-5" />
                Vender Pasajes
              </a>
              <a href="/admin/encomiendas" className="px-6 py-3 bg-slate-800 hover:bg-slate-900 text-white font-bold rounded-xl transition-all shadow-lg flex items-center gap-2">
